...
Das Ziel, worauf wir in dieser Arbeit hinarbeiten wollen soll sich am Ideal von einer Retransmission Time orientieren. Dies bedeutet, dass bei einem Paketverlust nur eine erneute Übertragung notwendig ist. Die Web Latenz soll sich dann auf eine RTT abgeschlossen sein. 
